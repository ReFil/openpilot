...
void Pigeon::init() {
  for (int i = 0; i < 10; i++) {
    ...
    // baud rate upping
    send("\xb5\x62\x06\x00\x14\x00\x01\x00\x00\x00\xd0\x08\x00\x00\x00\xc2\x01\x00\x07\x00\x07\x00\x00\x00\x00\x00\xc4\x96\xb5\x62\x06\x00\x01\x00\x01\x08\x22"s);
    util::sleep_for(100);
