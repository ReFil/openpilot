...
uint8_t crc8_lut_1d[256]; //CRC8 poly 0x1D, aka SAE j18650
...
void init_crc_lookup_tables() {
  ...
  gen_crc_lookup_table8(0x1D, crc8_lut_1d);      // CRC-8 SAE-j18650  for Retropilot
...
unsigned int ocelot_checksum(const std::vector<uint8_t> &d) {
